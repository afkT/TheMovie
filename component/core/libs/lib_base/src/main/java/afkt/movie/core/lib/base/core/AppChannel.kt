package afkt.movie.core.lib.base.core

import afkt.movie.core.lib.channel.AbstractChannelFlavors
...
object AppChannel : AbstractChannelFlavors {
    ...
    private const val IMPL_CLASS_NAME = "afkt.movie.core.lib.channel.ChannelFlavorsIMPL"
