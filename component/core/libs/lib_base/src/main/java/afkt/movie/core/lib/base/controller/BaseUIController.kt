...
import afkt.movie.core.lib.base.controller.inter.IController
import afkt.movie.core.lib.base.skin.AppThemeDefault
import afkt.movie.core.lib.ui.BR
import afkt.movie.core.lib.ui.databinding.CoreUiBaseHeaderBinding
...
import afkt.movie.core.lib.ui.listener.AppListener
import afkt.movie.core.lib.ui.listener.AppUI
import afkt.movie.core.lib.ui.skin.AppThemeKey
import afkt.movie.core.lib.ui.skin.AppThemeRes
...
class BaseUIController(
    ...
    val appThemeRes: AppThemeRes by lazy {
        AppThemeRes(owner, controller.isSyncSkin(), controller.ignoreSkinList())
    }
